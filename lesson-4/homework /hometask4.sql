...
Select employeeID, coalesce (FirstName, LastName) as FirstNonNullName
from Employees;
...
Select top 5 with ties  ProductID, ProductName, StockQuantity as SaleAmount from Products
